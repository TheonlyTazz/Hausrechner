...
export function buildLoanPortfolio({ inputs, required, equity, wiBank, wiBankEligible, roundCent, monthlyPayment, percentRate }) {
  ...
  const bank = Math.max(0, required - equity - employer - kfw - wi);
  const loans = [
